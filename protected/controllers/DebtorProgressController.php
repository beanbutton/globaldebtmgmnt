...
class DebtorProgressController extends Controller {
	...
	public function actionCreate() {
		...
		if (isset($_GET['id'])) {
			...
			{
				$model->total_debt= $debtorProgramInfo->total_debt;
				$model->settlement_amount= $model->total_debt * DebtCalculations::$SETTLEMENT_OFFER_PERCENTAGE;
				$model->savings= $model->total_debt - $model->settlement_amount;
			}
		}
	...
	public function actionIndex() {
		$dataProvider = new CActiveDataProvider('DebtorProgress');
	...
	public function actionAdmin() {
		$model = new DebtorProgress('search');
		$model -> unsetAttributes();
		// clear any default values
		if (isset($_GET['DebtorProgress']))
			$model -> attributes = $_GET['DebtorProgress'];
	...
	public function loadModel($id) {
		$model = DebtorProgress::model() -> findByPk($id);
		if ($model === null)
	...
	protected function performAjaxValidation($model) {
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'debtor-progress-form') {
