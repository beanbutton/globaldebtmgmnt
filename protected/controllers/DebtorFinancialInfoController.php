...
class DebtorFinancialInfoController extends Controller {
	/**
	...
	public function actionIndex() {
		$dataProvider = new CActiveDataProvider('DebtorFinancialInfo');
	...
	public function actionAdmin() {
		$model = new DebtorFinancialInfo('search');
		$model -> unsetAttributes();
		// clear any default values
		if (isset($_GET['DebtorFinancialInfo']))
			$model -> attributes = $_GET['DebtorFinancialInfo'];
	...
	public function loadModel($id) {
		$model = DebtorFinancialInfo::model() -> findByPk($id);
		if ($model === null)
	...
	protected function performAjaxValidation($model) {
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'debtor-financial-info-form') {
